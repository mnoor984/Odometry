...
public class Resources {
   ...
   */
  public static final double WHEEL_RAD = 2.098;     //2.130

  /**
   * The robot width in centimeters.
   */
  public static final double BASE_WIDTH = 15.85;     //16.3

  /**
   * The speed at which the robot moves forward in degrees per second.
   */
  public static final int FORWARD_SPEED = 150;  //250

  /**
   * The speed at which the robot rotates in degrees per second.
   */
  public static final int ROTATE_SPEED = 60;        //95    

  /**
   * The motor acceleration in degrees per second squared.
   */
  public static final int ACCELERATION = 2000;  //3000
